...
from dranspose.protocol import PREFIX, RedisKeys, ControllerUpdate, IngesterState, WorkerState
    ...
    async def register(self):
        ...
        while True:
            if isinstance(self.state, IngesterState):
                ...
                raise NotImplemented("Distributed Service not implemented for your Service")
